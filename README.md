...
- OBS: Essa é a **branch dev**, aqui **usamos o json-server simulando a api**. A master está com a implementação com localStorage para facilitar o deploy.
...
- OBS: A publicação do projeto foi feito a a partir da branch master em que usamos o localStorage como armazenamento de dados justamente para facilitar a publicação. Pois a ideia éo uso do json-server para simular uma api, e isso é feito aqui, na branch dev.
