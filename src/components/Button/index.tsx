  ...
  variants: {
    variant: {
      primary: `bg-white text-purple-400 shadow-md drop-shadow-md border-2 
        ...
        hover:shadow-lg hover:drop-shadow-xl dark:bg-zinc-950 
        dark:text-purple-300 dark:hover:bg-purple-300 dark:border-purple-300
        dark:hover:border-purple-200 dark:hover:text-white`,
      ...
      justify-center
      hover:bg-zinc-200 dark:text-gray-400 dark:hover:bg-zinc-800`,
    },
  },
  defaultVariants: {
    variant: 'primary',
